package com.example.thinkpositive;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] listMessages = {"Somos lo que pensamos. Todo lo que somos surge con nuestros pensamientos. Con nuestros pensamientos construimos el mundo.-Buddha.",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lightSwitch = (Switch) findViewById(R.id.lightMode);
        textMessage = findViewById(R.id.positiveMessage);
        rl = findViewById(R.id.background);
        textMessage.setText(listMessages[0]);
        ...
        lightSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(lightSwitch.isChecked()){
                    rl.setBackgroundColor(Color.parseColor("#FF855A5A"));
                }else{
                    rl.setBackgroundColor(Color.parseColor("#FFF0DBDB"));
                }
            }
        });
    }
    ...
    public void back(View view){
        if(numMessage==0){
            textMessage.setText(listMessages[listMessages.length-1]);
            numMessage=listMessages.length-1;
        }else{
            numMessage--;
            textMessage.setText(listMessages[numMessage]);
        }
    }
    ...
    public void search(View view){
        if(Integer.parseInt(editText.getText().toString())>=0 && Integer.parseInt(editText.getText().toString())<listMessages.length){
            textMessage.setText(listMessages[Integer.parseInt(editText.getText().toString())]);
        }else{
